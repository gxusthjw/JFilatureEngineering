...
public interface IUnivariateIntegralFunction extends IUnivariateFunction{
     ...
     * @return the definite integral value at
     * integrating range [{@code x0},{@code x1}].
     * @author JiweiHuang
     * @since 1.0.0_build-20181120
     */
    ...
    /**
     * <p>The method {@code setIntegralConstants(double integralConstants)}
     * is used to set the integral constants.</p>
     *
     * <p>Create date:2018-11-20.</p>
     *
